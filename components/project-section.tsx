...
const repositories = [
  ...
  // {
  //   name: "Oqura.ai",
  //   description: "Web based synthetic dataset generation application",
  //   language: "Typescript",
  //   link: "https://github.com/Oqura-ai/Oqura.ai",
  //   image: "https://opengraph.githubassets.com/1/Oqura-ai/Oqura.ai",
  //   color: "bg-blue-500",
  // },
  {
    name: "doc-sailor",
